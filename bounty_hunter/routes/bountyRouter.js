...
const bounties = [
    ...
    {firstName: "Hidding", lastName: "FromYou", isAlive: 'Alive', bountyAmount: 200, isJedi: 'Sith', _id: uuidv4()},
...
bountyRouter.put('/:bountyId', (req, res) => {
    const bountyId = req.params.bountyId //ssigning bountyId to bountyId which comes from the request body's params
